...
public class Automobile implements Serializable {
	...
	private String make = "NoMaker";
	private String model = "NoModel";
	...
	// Getter
	public void addChoice(Option optionChoice){
		Choice.add(optionChoice);
	}
	
	public void addNewChoice(String name, int price){
		Option chosen = new Option(name, price);
		Choice.add(chosen);
	}
	...
	public Option findOptionChoice(String OptionName) {
	...
	public int getChoicePrice(int index){
